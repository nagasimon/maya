...
def evaluateCamPath():
    ...
    try:
        ...
        cmds.setAttr('curveBake'+'.visibility',0)
...
def setupOnLocator():
    ...
    cmds.setAttr(centralLocator[0] + '.animationOffset', 2500) # cmds.playbackOptions(query=True, minTime=True))
